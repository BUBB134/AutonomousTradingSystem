...
This covers formatting, linting, repository-skill validation, package-boundary enforcement, strict
static types, tests, and package build. CI must pass before merge. Tests must not require
public-network access or external services.
